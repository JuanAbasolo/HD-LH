...
office: "3S40B"
classroom: "32 2S08G"
classhours: "As 18:30-20 + Og 16:30-20:00"
...
Korreo elektronikoak ikasleek (zein neuk) [netiketa](https://eu.wikipedia.org/wiki/Netiketa) segituaz egin behar dira. Netiketaren kontzeptu bera baino jarrerazko edukia ere Gaitasun komunikatiboaren baitan sartzen da. 

Korreo instituzionala astean batean zabaltzeko ohitura dut, hori baita SPAMa-eta kudeatzeko neuk darabildan modua. Beraz, **premiazko komunikazioetarako ez da eraginkorra**.

## Beherapenak eta deskontuak

Entregatze data baino 48 ordu berandura arte hartuko dira lanak eta horietan azken emaitzaren %60 zenbatuko da, %40ko deskontua aplikatuko zaie. Hori baino beranduago aurkeztutakorik ez da kalifikatuko eta 0 emaitza izango lukete.

Behar ona eta behar perfektua elkarren arerioak dira.
...
Zintzotasun falta ere bada norberak lanik egin ez eta taldekideek egindakoaren bizkar izena ezartzea. Hori denok jakin badugu ere, gogoratu beharra egoten da inoiz.
...
Egun honetan ikasgaiaren, irakaslearen eta ikasleen aurkezpena egiteaz gain, lehenengo gaia landuko da

Egin beharrekoa: Talde laneko aurkezpena
...
Bigarren gaiarekin hasi behar dugu eta curriculumaren inguruko lana egin beharko duzue.
...
Oharra  
  : Aste hau ere on-line garatuko da.
...
Oharra  
  : Aste honetako astelehenean gogoratzen ditugu Cortezek eta Pizzarrok eragindako genozidioak eta Atahualparen martiritza; hori dela eta, besteak beste, ez dugu klaserik izango.
...
Egin beharreko lana  
  : Estrategien gaineko baliabide didaktiko kokatua garratzea

##  `r advdate(mon, 10)`: Ebaluazioak

Azkenenko asteko lehenengo eguna erabiliko da, baliabide didaktikoen aurkezpenerako.

Azken egunean azterketarako nondik norakoetan jardungo da gehienbat... irakasleak nahi lukeen moduan edukirik atzeratu ez bada. DElako egoerak atzeratzea eragingo balu, azken klase hori erabiliko litzateke amaitzeko.
