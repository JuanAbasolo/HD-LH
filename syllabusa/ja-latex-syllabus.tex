%% Honetan oinarritua: https://github.com/svmiller/svm-r-markdown-templates/blob/master/svm-latex-syllabus.tex
...
Telefonoa: $if(phone)$\texttt{$phone$}$else$TBD$endif$ & Telegram: $if(telegram)$\href{http://t.me/$telegram$}{\tt $telegram$}$else$TBD$endif$\\
Tutoretzak: $if(officehours)$$officehours$$else$TBD$endif$  &  Klaseak: $if(classhours)$$classhours$$else$TBD$endif$\\
Bulegoa: $if(office)$$office$$else$TBD$endif$  & Ikasgela: $if(classroom)$$classroom$$else$TBD$endif$\\
	&  \\
	\hline
	\end{tabular*}
